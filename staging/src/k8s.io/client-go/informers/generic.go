...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case lifecyclev1alpha1.SchemeGroupVersion.WithResource("lifecycleevents"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Lifecycle().V1alpha1().LifecycleEvents().Informer()}, nil
	case lifecyclev1alpha1.SchemeGroupVersion.WithResource("lifecycletransitions"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Lifecycle().V1alpha1().LifecycleTransitions().Informer()}, nil
